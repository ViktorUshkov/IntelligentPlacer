...
3) *Предварительная проверка:* чтобы исключить случаи, когда сразу понятно, что предметы не поместятся, введём предварительную проверку площадей. Если сумма площадей предметов больше площади многоугольника - сразу выводим False
